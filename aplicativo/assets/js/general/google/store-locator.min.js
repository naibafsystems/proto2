 ...
 */
    ...
    storeLocator.GMEDataFeed.prototype.getStores = function (a, b, c) {
        ...
        $.getJSON("https://www.googleapis.com/mapsengine/v1/tables/" + this.tableId_ + "/features?callback\x3d?", {key: this.apiKey_, where: a, version: "published", maxResults: 300}, function (a) {
            a = d.parse_(a);
    ...
    storeLocator.Panel = function (a, b) {
        ...
        this.settings_ = $.extend({locationSearch: !0, locationSearchLabel: "Where are you?", featureFilter: !0, directions: !0, view: null}, b);
    ...
    storeLocator.Panel.prototype.renderDirections_ = function () {
        ...
        if (this.directionsFrom_ && this.directionsTo_) {
            ...
            this.directionsService_.route({origin: this.directionsFrom_, destination: this.directionsTo_.getLocation(), travelMode: google.maps.DirectionsTravelMode.DRIVING}, function (c, d) {
