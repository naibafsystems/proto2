...
class Expertos extends CI_Controller {
    ...
    public function index() {
        ...
        $datos["titulo"] = $this->lang->line('Red de Expertos');
        $datos["contenido"] = "transversal/expertos";
        $datos['expertos'] = $this->expertos_model->expertosRegistradosTodos();
    ...
    public function crearExperto() {
        ...
        $datos["contenido"] = "administrador/crearExperto";
    ...
    public function guardarExperto() {
        ...
        if ($resultadoID) {
            ...
            redirect(base_url('administrador/expertos/'), 'refresh');
        } else {
