...
class Eventos extends CI_Controller {
    ...
    public function index() {
        ...
        $datos["titulo"] = $this->lang->line('Eventos de Capacitacion General');
        $datos["contenido"] = "transversal/eventos";
        $datos['eventos_nec_publicados'] = $this->eventos_model->eventosPublicadosNecesidad();
    ...
    public function crearEvento() {
        ...
        $datos["contenido"] = "coordinador/crearEvento";
    ...
    public function guardarEvento() {
        ...
        if (!$this->upload->do_upload('documento')) {
            ...
            redirect(base_url('coordinador/eventos/'), 'refresh');
            exit;
        } else {
