    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="form-horizontal" enctype="multipart/form-data" role="form" id="formCrearEvento" action="<?php echo base_url('administrador/eventos_necesidad/guardarEvento/') ?>" name="formCrearEvento" method="post">
