    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="form-horizontal" enctype="multipart/form-data" role="form" id="formCrearEvento" action="<?php echo base_url('administrador/eventos/actualizarEvento/') ?>" name="formCrearEvento" method="post">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-6">
                            <select class="validate[required] form-control select2-select" id="pais_organiza" name="pais_organiza[]" multiple="multiple">
								...
								$paisesOrg = explode(";",$infoEvento[0]->paises);
								
                                foreach ($paises as $row) {
									$bandera = 0;
									foreach($paisesOrg as $row2)
									{
										if($row2 == $row->codi_pais)
										{
											echo "<option value='" . $row->codi_pais . "' selected>" . $row->desc_pais . "</option>";
											$bandera = 1;
										}
									}
									if($bandera == 0)
