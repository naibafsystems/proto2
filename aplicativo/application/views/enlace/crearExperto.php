    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="form-horizontal" enctype="multipart/form-data" role="form" id="formCrearExperto" action="<?php echo base_url('enlace/expertos/guardarExperto/') ?>" name="formCrearExperto" method="post">
