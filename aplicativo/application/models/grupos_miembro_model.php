 ...
 * 
 */
class grupos_miembro_model extends CI_Model {
    ...
    public function gruposMiembro($id_usuario) {
        $query = $this->db->query("SELECT gt.id_grupo, nombre_grupo, objetivo, email, mg.estado "
                                . "FROM grupo_trabajo gt "
                                . "JOIN miembros_gt mg ON mg.id_grupo = gt.id_grupo "
                                . "JOIN usuario us ON us.id_usuario = gt.id_coordinador "
                                . "WHERE mg.estado = 'AC' "
                                . "AND mg.id_usuario = ".$id_usuario." ");
