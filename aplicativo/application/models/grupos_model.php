...
class grupos_model extends CI_Model {
	...
	function actualizarGrupo($id_grupo, $nombre, $objetivo, $coordinador)
    {
        $data = array(
            'nombre_grupo' => $nombre,
            'objetivo' => $objetivo,
        ...
        return $this->db->update('grupo_trabajo', $data);
    }
    ...
    public function datosGrupo($id_grupo) {
        $query = $this->db->query("SELECT id_grupo, nombre_grupo, objetivo, email, estado, id_coordinador "
                                . "FROM grupo_trabajo "
                                . "JOIN usuario ON usuario.id_usuario = grupo_trabajo.id_coordinador "
                                . "WHERE estado = 'AC' "
